...
export class LinesSelectionPage {
    ...
    async initLineButtons() {
        ...
        try {
            ...
            if (lines === null) {
                ...
                const availableLinesHashMap = this.initAvailableLineButtons(lines);
    ...
    initAvailableLineButtons(lines) {
        ...
        const availableLinesHashMap = new Set();
        lines.forEach((line) => {
            ...
            const lineButtonContainer = document.getElementById(`${line.name}_button_container`);
            const lineButton = lineButtonContainer?.querySelector("button");
